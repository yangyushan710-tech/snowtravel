...
export const mockArticles = [
  {
    id: 1,
    title: '东北民俗非遗的现代蜕变',
    content: '东北民俗与非遗在现代化进程中，通过节庆活化、教育传承和创新设计（如鱼皮画文创）持续焕发生命力，成为中华文化多元一体格局的重要见证。',
    author: '东北文化研究中心',
  ...
  {
    id: 2,
    title: '查干湖冬捕：千年渔猎文化的活态传承',
    content: '查干湖冬捕是蒙古族传统渔猎文化的重要组成部分，被列入国家级非物质文化遗产名录。每年冬季，渔民们在冰面上凿洞下网，进行大规模捕鱼活动，吸引了众多游客前来观赏。',
    author: '吉林省文化厅',
  ...
  {
    id: 3,
    title: '东北冰雪节：民俗与现代的完美融合',
    content: '东北冰雪节是东北地区最具代表性的冬季节庆活动之一，集冰雪艺术、民俗表演、体育竞技于一体，展示了东北人民的创造力和对生活的热爱。',
    author: '黑龙江省旅游局',
